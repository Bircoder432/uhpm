...
impl Package {
    ...
    /// Creates package from TOML file
    ...
    /// Saves package to TOML file
    pub fn save_to_toml(&self, path: &Path) -> Result<(), Box<dyn std::error::Error>> {
...
/// Parses package metadata from file
...
/// Gets package installation path
